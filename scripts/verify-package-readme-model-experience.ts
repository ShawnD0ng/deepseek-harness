...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/tui-app': { kind: 'none', reason: 'The interactive runner submits prompts as ordinary user messages and its own command handlers never reach the model; prompts and tools belong to the composed base rows.' },
